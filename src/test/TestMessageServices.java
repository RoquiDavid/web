...
public class TestMessageServices {
	public static void main(String[] args) {
		...
		try {
			...
			JSONObject jsonPostCreateMessage = MessageServices.createMessage(1,"Gabriel" ,key, "boujour");
			System.out.println("Results for create :" + jsonPostCreateMessage);
			/* L'utilisateur 1 veut savoir ce qu'a dit l'utilisateur 1*/
			JSONObject jsonGetMessage = MessageServices.getMessage(key, jsonPostCreateMessage.getString("mid"), 1,1);
			System.out.println("Results for get 1:1" + jsonGetMessage);
			
			
			
			JSONObject jsonPostCreateMessage2 = MessageServices.createMessage(7,"DAVID" ,key2, "ça va ?");
			System.out.println("Results for create :" + jsonPostCreateMessage2);
			/* L'utilisateur 1 veut savoir ce qu'a dit l'utilisateur 7*/
			JSONObject jsonGetMessage2 = MessageServices.getMessage(key, jsonPostCreateMessage2.getString("mid"), 1,7);
			System.out.println("Results for get 1:7 :" + jsonGetMessage2);
			
			JSONObject jsonPostCreateMessage2Bis = MessageServices.createMessage(7,"DAVID" ,key2, "ça va 1?");
			System.out.println("Results for create :" + jsonPostCreateMessage2Bis);
			
			JSONObject jsonPostCreateMessage2BisBis = MessageServices.createMessage(7,"DAVID" ,key2, "ça va 2?");
			...
			JSONObject jsonPostCreateMessage4 = MessageServices.createMessage(8,"Quentin" ,key3, "hello tout le monde");
			System.out.println("Results for create :" + jsonPostCreateMessage4);
			/* L'utilisateur 2 veut savoir ce qu'a dit l'utilisateur 8*/
			JSONObject jsonGetMessage4 = MessageServices.getMessage(key, jsonPostCreateMessage4.getString("mid"), 2,8);
			System.out.println("Results for get :" + jsonGetMessage4);
			
			JSONObject jsonPostCreateMessage4Bis = MessageServices.createMessage(8,"Quentin" ,key3, "boujour2");
			System.out.println("Results for create :" + jsonPostCreateMessage4Bis);
			
			JSONObject jsonPostCreateMessage5 = MessageServices.createMessage(9,"Jeremy" ,key4, "ça va ?");
			System.out.println("Results for create :" + jsonPostCreateMessage5);
			/* L'utilisateur 8 veut savoir ce qu'a dit l'utilisateur */
			JSONObject jsonGetMessage5 = MessageServices.getMessage(key4, jsonPostCreateMessage5.getString("mid"), 8,9);
			...
			/* MAJ du message */
			JSONObject jsonPostUpdate = MessageServices.update(key3, jsonPostCreateMessage4.getString("mid"), "j'ai update", 8);
			System.out.println("Result update: "+ jsonPostUpdate);
			/* Vétification après MAJ du message*/
			JSONObject jsonGetMessageUpdate = MessageServices.getMessage(key3, jsonPostCreateMessage4.getString("mid"), 8,8);
